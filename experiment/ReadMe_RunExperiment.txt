Folder to run experiment

Task contains 3 subtasks:
	1. Operation-Span-Task (./experiments/operation_span_task.html)
	2. Two-Armed-Bandit (./experiments/experiment.html)
		--> change stimulus set in ./js/experiment.js
